...
<table border="0" style="border: none; border-collapse: collapse;">
  <tr valign="top">
    <td width="60%" style="border: none;"><img src="figures/cont_fea_boxplot.png" width="100%"/></td>
    <td width="35%" style="border: none;"><img src="figures/bin_fea_barplot.png" width="100%"/></td>
  </tr>
</table>
