...
、、、text
notebooks/1_transaction_data_generation.ipynb
notebooks/2_user_log_data_generation.ipynb
notebooks/3_data_exploration.ipynb
...
├── processed/  # Cleaned and feature-engineered datasets generated by notebooks/
...
2. Place in data/raw/
3. Run preprocessing scripts in notebooks
